...
async def help_for_admin(msg: Message):
    ...
    msg_text = escape_special_chars('Подсказка для администратора:'
                                    ...
                                    '{user_rep} - отображает всю репутацию пользователя\n'
                                    '{user_points} - показывает сколько баллов на счету у пользователя\n'
                                    '{user_status} - статус пользователя\n'
                                    '{add_points} - количество добавляемых очков администратором (использовать для уведомления "Начисление от администратора")\n'
                                    '{reduce_points} - количество списываемых администратором быллов (использовать для уведомления "Списание баллов")\n')
